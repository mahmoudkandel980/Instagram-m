...
const SmScreensStories = (props: StoriesInterface & UserInterface) => {
                    ...
                    >
                        ...
                        >
                                ...
                                className={`${
                                    (currentIndex === 1 ||
                                        currentStory.imgs.length <
                                            Number(story)) &&
                                    "hidden"
                                } absolute top-[50%] left-[5%] select-none sm:left-[30%] z-50 cursor-pointer`}
                            >
                                <span>
                            ...
                            <div
                                ...
                                className={`${
                                    (currentIndex ===
                                        modifiedStories.length - 2 ||
                                        currentStory.imgs.length >
                                            Number(story)) &&
                                    "hidden"
                                } absolute top-[50%] right-[5%] select-none sm:right-[30%] z-50 cursor-pointer`}
                            >
                                <span>
...
export default SmScreensStories;
