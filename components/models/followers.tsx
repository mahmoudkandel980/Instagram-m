...
import ProfileFollowersModel from "./followers/profileFollowersModel";
import SpecificFollowersModel from "./followers/specificFollowersModel";
...
import { ModeInterFace, FollowersInterface } from "../../interfaces/interfaces";

const Followers = (
    props: ModeInterFace & FollowersInterface & UserInterface & StoriesInterface
): JSX.Element => {
    ...
    const hideModelHandler = () => {
        ...
        setTimeout(() => {
            toggleShowRemoveFollwerModel(false);
                ...
                <div className="pt-2 flex flex-col items-start h-full">
                    ...
                    >
                        ...
                        <div className="sm:pr-32">
                            <span className="font-[700]">Followers</span>
                        </div>
                        <div
                            onClick={hideModelHandler}
